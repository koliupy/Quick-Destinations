...
public class MapFragment extends Fragment implements OnMapReadyCallback,
    ...
    //ROB: HERE BOOLEANS TO CHECK ELIGIBILITY


    //ROB: ALSO THIS, WHOLE FUNCTION TO CHECK
...
//ROB PUT THIS
                ...
                if (size > 1) {
                    ...
                    //ROB PUT THIS
                    if(line != null) {
                        //System.out.println(currDest.toString());
                        line.remove();
                        mMap.clear();
                        ...
                        /*for (int ii = 1; ii < size; ii++) {
                            if (currDest.equals(((MainActivity) getActivity()).getLatLngs().get(ii).second))
                                ((MainActivity) getActivity()).getLatLngs().remove(ii);
                        }*/
            ...
            public void onResponse(Call<Example> call, Response<Example> response) {
                try {
                    ...
                    for (int i = 0; i < response.body().getRoutes().size(); i++) {
                        ...
                        int timeTemp = Integer.parseInt(time.substring(0, time.indexOf(" ")));
                        if(timeTemp <= minTime) {
                            System.out.println(isEligible(dest, timeTemp, type));
                            if(isEligible(dest, timeTemp, type)) {
                                minTime = timeTemp;
                                if (line != null)
                                    line.remove();
                                /*
                                double a = dest.latitude;
                                double b = dest.longitude;
                                currDest = new LatLng(a,b);
                                */
                                removeIndex = index;
